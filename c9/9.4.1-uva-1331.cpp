// https://onlinejudge.org/index.php?option=com_onlinejudge&Itemid=8&category=446&page=show_problem&problem=4077
// https://github.com/aoapc-book/aoapc-bac2nd/blob/master/ch9/UVa1331.cpp
// Rujia Liu
#include<cstdio>
#include<cstdlib>
#include<cmath>
